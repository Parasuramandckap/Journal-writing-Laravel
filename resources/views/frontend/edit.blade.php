...
<div class="ml-56 mt-20">
    <div class="writing-container mt-8">
        ...
        <div class="title text-center mt-4 mb-6">
            <input type="text" class="rounded-md userTitle text-center shadow-md border-0 outline-none bg-white userTitle" id="userTitle" placeholder="Title....."  value="{{$content->title}}"/>
        </div>
